        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function registerHighlightHandler() {
                ...
                rendition.on("selected", function (cfiRange, contents) {
                    ...
                    // wait for mobile drag handles to settle
                    highlightPopupTimer = setTimeout(() => {
                        const stableSelection = contents.window.getSelection();
                        const stableText = stableSelection.toString();

                        if (!stableText || stableText.trim().length < 2) return;

                        const range = stableSelection.getRangeAt(0);
                    ...
                    }, 700); // important delay for mobile dragging
                });
            }
