<header class="biblo-topbar">
    ...
    <div class="flex items-center gap-2 sm:gap-3">
        ...
        <button type="button" id="themeToggle" class="icon-btn theme-toggle" aria-label="Ganti mode gelap/terang" title="Ganti mode">
            <svg class="theme-icon-sun" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <svg class="theme-icon-moon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<script>
    (function () {
        ...
        toggle.addEventListener('click', function () {
            ...
            localStorage.setItem('biblo-theme', nextTheme);
