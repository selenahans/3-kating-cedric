<aside class="biblo-sidebar">
    <div class="space-y-12">
        ...
        <nav class="sidebar-nav-group">           
            {{-- Dashboard / Home Link --}}
            <a href="/dashboard" class="sidebar-link {{ request()->is('dashboard*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
            ...
            {{-- Explore Link --}}
            <a href="/explore" class="sidebar-link {{ request()->is('explore*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                <div class="sidebar-icon">
            ...
            {{-- My Library Link --}}
            <a href="/mylibrary" class="sidebar-link {{ request()->is('mylibrary*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                <div class="sidebar-icon">
            ...
            {{-- Notes Link --}}
            <a href="/mynotes" class="sidebar-link {{ request()->is('notes*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                <div class="sidebar-icon">
            ...
            {{-- My Pet Link --}}
            <a href="/mypet" class="sidebar-link {{ request()->is('mypet*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                <div class="sidebar-icon">
