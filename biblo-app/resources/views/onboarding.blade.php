...
<head>
    ...
    <style>
        ...
        input:checked + div { @apply border-biblo-moss bg-biblo-moss/10 ring-2 ring-biblo-moss/20 text-biblo-moss; }
    </style>
</head>
...
{{-- action="{{ route('onboarding.store') }}" --}}
        <form  method="POST" id="onboardingForm">
            ...
            <div id="step-1" class="step-content active text-center">
                ...
                <p class="text-biblo-charcoal/50 text-sm mb-8">Telur ini akan menetas menjadi pet yang menemanimu membaca. Siapa namanya?</p>
                ...
                <button type="button" onclick="nextStep(2)" class="mt-12 bg-biblo-charcoal text-white px-10 py-4 rounded-2xl font-bold shadow-xl hover:bg-black transition-all">
            ...
            <div id="step-2" class="step-content text-center">
                ...
                <p class="text-biblo-charcoal/50 text-sm mb-8">Berapa lembar yang ingin kamu selesaikan setiap harinya?</p>
                ...
                <div class="flex items-center justify-center gap-4 mt-12">
                    <button type="button" onclick="nextStep(1)" class="text-biblo-charcoal/40 font-bold text-sm hover:text-biblo-charcoal transition">Kembali</button>
                    <button type="button" onclick="nextStep(3)" class="bg-biblo-charcoal text-white px-10 py-4 rounded-2xl font-bold shadow-xl hover:bg-black transition-all">
                        Hampir Selesai
                    </button>
                </div>
            </div>
            ...
            <div id="step-3" class="step-content text-center">
                ...
                <div class="flex flex-wrap justify-center gap-3">
                    @foreach(['Fiksi', 'Psikologi', 'Bisnis', 'Teknologi', 'Sains', 'Sejarah', 'Religi', 'Komik'] as $genre)
                    <label class="cursor-pointer">
                        <input type="checkbox" name="genres[]" value="{{ $genre }}" class="sr-only">
                        <div class="bg-white border-2 border-gray-100 rounded-full px-6 py-3 font-bold text-sm text-biblo-charcoal/60 transition-all hover:border-biblo-moss">
                            {{ $genre }}
                        </div>
                    </label>
                    @endforeach
                ...
                <div class="flex items-center justify-center gap-4 mt-12">
                    <button type="button" onclick="nextStep(2)" class="text-biblo-charcoal/40 font-bold text-sm hover:text-biblo-charcoal transition">Kembali</button>
                    <button type="submit" class="bg-biblo-moss text-white px-10 py-4 rounded-2xl font-extrabold shadow-xl hover:bg-biblo-charcoal transition-all">
                        Mulai Petualangan!
                    </button>
                </div>
            </div>
    ...
    <p class="absolute bottom-8 left-0 right-0 text-center text-[10px] font-black text-biblo-charcoal/20 tracking-widest uppercase">
