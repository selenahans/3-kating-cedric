    ...
    <div class="max-w-5xl mx-auto space-y-10">
        ...
        <header class="flex flex-col md:flex-row justify-between items-end gap-4">
            ...
            <div class="flex gap-3">
                ...
                <a
                    class="bg-white border border-biblo-greige/30 px-6 py-3 rounded-2xl shadow-sm flex items-center gap-2 hover:bg-biblo-oat transition-all group">
...
<section class="relative bg-biblo-oat rounded-[60px] aspect-video md:aspect-[21/9] overflow-hidden flex flex-col items-center justify-center border border-biblo-greige/20 shadow-inner p-8">
    ...
    {{-- MASKOT AREA --}}
    <div class="relative flex flex-col items-center group mb-16 md:mb-20">
        {{-- Shadow --}}
        ...
        <div class="absolute -top-12 left-1/2 -translate-x-1/2 whitespace-nowrap bg-white/80 backdrop-blur-md border border-white/50 px-4 py-1.5 rounded-2xl shadow-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            <p class="text-[10px] font-black text-biblo-charcoal uppercase tracking-tighter">
    ...
    <div class="absolute bottom-6 left-6 right-6 grid grid-cols-2 lg:grid-cols-4 gap-3">
        @php
            $stats = [
        ...
        @foreach($stats as $stat)
            <div class="bg-white/40 backdrop-blur-md border border-white/60 p-3 md:p-4 rounded-[2rem] shadow-sm flex flex-col justify-between">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="space-y-3">
                    <div
                        class="bg-white p-5 rounded-[32px] border border-biblo-greige/20 flex items-center justify-between group hover:shadow-xl hover:shadow-biblo-sage/5 transition-all">
                        ...
                        <button
                            class="bg-biblo-charcoal text-white text-[10px] font-black px-6 py-2.5 rounded-xl hover:bg-biblo-moss transition-colors">START</button>
                    </div>

                    <div
                        class="bg-white p-5 rounded-[32px] border border-biblo-greige/20 flex items-center justify-between opacity-60">
                        <div class="flex items-center gap-4">
                            <div
            ...
            <div
                class="bg-biblo-charcoal rounded-[45px] p-8 text-white relative overflow-hidden flex flex-col justify-between">
                <div>
