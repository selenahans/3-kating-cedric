...
<head>
    ...
    <style>
        body {
            ...
            background-color: #FDFBF8; /* biblo-cream */
        }
        ...
        .input-field {
            width: 100%;
            border: 1.5px solid rgba(209, 209, 199, 0.4); /* biblo-greige/40 */
            ...
            background-color: #F4EFE6; /* biblo-oat */
        }

        .input-field:focus {
            outline: none;
            border-color: #4A5D23; /* biblo-moss */
    ...
    <div class="min-h-screen flex w-full">
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-16 relative bg-biblo-cream z-10">
            <div class="w-full max-w-[440px] animate-fade-in-up">
                ...
                {{-- Mobile Logo --}}
                <div class="lg:hidden mb-6 flex items-center gap-2 select-none">
                ...
                <h1 class="text-3xl lg:text-4xl font-extrabold mb-3 text-biblo-charcoal tracking-tight">Mulai Perjalananmu!</h1>
                ...
                <form action="{{route('register.process')}}" method="POST" class="space-y-5">
                    @csrf
                    <div>
                        <label for="name" class="block text-[11px] font-black uppercase tracking-widest text-biblo-charcoal/60 mb-2 ml-1">Nama Lengkap</label>
                        <input type="text" name="name" id="name" placeholder="Masukkan nama lengkap" class="input-field" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="relative">
                            <label for="password" class="block text-[11px] font-black uppercase tracking-widest text-biblo-charcoal/60 mb-2 ml-1">Kata Sandi</label>
                            <div class="relative">
                                <input type="password" name="password" id="password" placeholder="••••••••" class="input-field pr-11" required>
                                <button type="button" class="toggle-pass absolute right-3 top-1/2 -translate-y-1/2 text-biblo-charcoal/40 hover:text-biblo-moss transition p-1" data-target="password">
                        ...
                        <div class="relative">
                            <label for="password_confirmation" class="block text-[11px] font-black uppercase tracking-widest text-biblo-charcoal/60 mb-2 ml-1">Konfirmasi</label>
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="••••••••" class="input-field pr-11" required>
                                <button type="button" class="toggle-pass absolute right-3 top-1/2 -translate-y-1/2 text-biblo-charcoal/40 hover:text-biblo-moss transition p-1" data-target="password_confirmation">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>
                    ...
                    <div class="flex items-start gap-3 pt-2">
                        <input id="terms" name="terms" type="checkbox" class="mt-1 h-5 w-5 text-biblo-moss focus:ring-biblo-moss border-biblo-greige/40 rounded-md bg-biblo-oat" required>
                        <label for="terms" class="text-xs text-biblo-charcoal/60 font-medium leading-normal">
                            Saya setuju dengan <a href="#" class="text-biblo-charcoal font-bold hover:underline">Syarat & Ketentuan</a> serta <a href="#" class="text-biblo-charcoal font-bold hover:underline">Kebijakan Privasi</a> yang berlaku.
                        </label>
                    </div>
                    ...
                    <button type="submit" class="w-full bg-biblo-charcoal text-white py-5 mt-4 rounded-[2rem] font-bold text-sm tracking-widest uppercase hover:bg-biblo-moss transition-all hover:shadow-xl active:scale-95 shadow-lg shadow-biblo-charcoal/20">
                        Buat Akun Sekarang
                    </button>
                </form>

                <p class="mt-8 text-center text-biblo-charcoal/60 font-medium text-sm">
                    Sudah punya akun? <a href="{{ route('login') }}" class="font-extrabold text-biblo-charcoal hover:text-biblo-moss transition-colors">Masuk di sini</a>
                </p>
            </div>
        </div>
