        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-biblo-charcoal rounded-[45px] p-8 text-white relative overflow-hidden shadow-2xl shadow-biblo-charcoal/20 group">
                <div class="relative z-10">
                    ...
                    <h2 class="text-5xl font-extrabold tracking-tighter">{{ $totalBooks }} <span class="text-sm font-bold text-biblo-greige/60 ml-2 uppercase">Books</span></h2>
                </div>
        ...
        <section class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-10">
            @forelse($books as $book)
                ...
                <a href="{{ route('book.read', ['id' => $book->id]) }}" class="group cursor-pointer block">
                    <div class="aspect-[3/4] bg-biblo-greige rounded-[1rem] mb-5 overflow-hidden shadow-md group-hover:shadow-2xl transition-all duration-500 relative">
