            ...
            <table width="100%" max-width="520" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="font-size:15px;color:#2D2D2A;line-height:1.6;padding-bottom:25px;">
                        ...
                        Kami menerima permintaan untuk mereset password akun Biblo Anda.
                        Silakan klik tombol di bawah ini untuk membuat password baru dan kembali membaca.
                    </td>
                </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:20px;">
                <tr>
                    <td align="center" style="font-size:12px;color:#D1D1C7; font-weight:bold;">
                        ...
                        <br><br>
                        <span style="text-transform:uppercase; letter-spacing:1px;">© {{ date('Y') }} Biblo. All rights reserved.</span>
                    </td>
                </tr>
            </table>
